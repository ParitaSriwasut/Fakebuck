...
const registerSchema = Joi.object({
  ...
  emailOrMobile: Joi.alternatives([
    // เป็นได้ทุกเมล . -> .com  .co.th  tlds: ["com"]
...
// ค่า input ที่จะเอาไป validate
const validateRegister = (input) => {
  // ถ้าไม่มี err -> undefined
  // ถ้ามี err -> return obj { firstName: ...}
  const { error } = registerSchema.validate(input, { abortEarly: false });
  // console.dir(error);
  // ค่าเริ่มต้นกำหนดเป็น obj เปล่า
  if (error) {
